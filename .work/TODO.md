...
- [ ] F09 Sync data — **P1 范围已裁定（Table Sync manual 最小闭环，交付即 pass）；R6 五路在飞（E1 五路同判 fail-open 已修 dd46a3eb1d + minors 批 aabe3587fe，R5 为 error 轮连击重置 0/3）**：P2 生命周期/P3 realtime/P4 LTAR 记分阶段 backlog；Custom Sync 裁记 fork 限制（f09-research.md）
