...
- [ ] F09 Sync data — **P1 范围已裁定（Table Sync manual 最小闭环，交付即 pass）；R9 五路在飞（R8 lane5 坐实 storeToRefs 缺失 → 跳转两腿死代码，已修 5e3d736b2a；连击 0/3）**：P2 生命周期/P3 realtime/P4 LTAR 记分阶段 backlog；Custom Sync 裁记 fork 限制（f09-research.md）
