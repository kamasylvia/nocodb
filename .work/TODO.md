...
- [ ] F09 Sync data — **P1 范围已裁定（Table Sync manual 最小闭环，交付即 pass）；R7 外部阵容五路在飞（R6 四路同判两 error 已修 5a11c4ab86，连击 0/3）**：P2 生命周期/P3 realtime/P4 LTAR 记分阶段 backlog；Custom Sync 裁记 fork 限制（f09-research.md）
